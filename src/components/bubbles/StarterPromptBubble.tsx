...
export const StarterPromptBubble = (props: Props) => (
  <>
    <button
      ...
      class={`px-3 py-2.5 ml-1 whitespace-pre-wrap max-w-full rounded-lg rounded-tr-none text-gray-880 animate-fade-in host-container cursor-pointer hover:brightness-90 active:brightness-75 ${
